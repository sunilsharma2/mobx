...
class OrdersHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarCommon(Text("MY ORDERS",style:  Theme.of(context).textTheme.bodyText2!.copyWith(fontWeight: FontWeight.w600)),
        ...
        body: Container(child: Center(child: Text("orders screen"),),));
  }
}
